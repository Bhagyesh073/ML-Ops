Project Title:: MLOps Assignment 1
Objective : To understand Version Control using Github For ML Project
DataSet: sample CSV dataset used for Learning purpose
Outcome: Learn how to manange and track ML Project Files 
[Iris.csv](https://github.com/user-attachments/files/24463737/Iris.csv)
